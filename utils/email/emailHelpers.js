        ...
        <tr>
          <td align="center" style="padding: 50px 20px;">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width: 600px; background-color: ${BRAND_COLORS.white}; border-radius: 20px; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.1); overflow: hidden;">
              <!-- Header -->
              <tr>
                <td style="background: ${BRAND_COLORS.white}; padding: 42px 40px; text-align: center;">
                  <img src="${LOGO_URL}" alt="Freshlancer Logo" style="max-width: 360px; width: 100%; height: auto; display: block; margin: 0 auto;" />
                </td>
              </tr>
              <!-- Content -->
              <tr>
